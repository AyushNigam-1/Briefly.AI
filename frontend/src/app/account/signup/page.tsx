            ...
            >
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
                    ...
                    >
                        ...
                        >
                            {loading ? <LoaderIcon className="animate-spin w-5 h-5 sm:w-6 sm:h-6" /> : "Sign Up"}
                        </motion.button>

                        <motion.div className="relative flex py-2 items-center" variants={itemVariants}>
                            <div className="flex-grow border-t border-white/10"></div>
                            <span className="flex-shrink mx-3 sm:mx-4 text-gray-500 text-[10px] sm:text-xs text-center">Or continue with</span>
                            <div className="flex-grow border-t border-white/10"></div>
                        </motion.div>
