                    ...
                    <div className='flex justify-between items-center mt-auto'>
                            ...
                            <h6 className='text-gray-300 font-bold w-min py-1 p-1 rounded-xl flex items-center gap-1'>
                                {
                                    ...
                                    </svg> : summary.type == 'Image' ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                        ...
                        <div className="flex gap-2" >
                            <button onClick={() => markSummaryAsFavorite(summary.id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`size-5 hover:text-white stroke-white stroke-2 ${favourites.includes(summary.id) ? 'fill-red-500 stroke-none':'fill-transparent'}`}>
