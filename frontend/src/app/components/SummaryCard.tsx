                    ...
                    <div className='flex justify-between items-center mt-auto'>
                        ...
                        <div className="flex gap-2" >
                            <button onClick={() => markSummaryAsFavorite(summary.id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`size-5 hover:text-white stroke-white stroke-2  ${favourites.includes(summary.id) && 'fill-red-500 stroke-none'}`}>
