...
export default function SettingsDialog({ isOpen, setIsOpen }: any) {
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <div
            className="w-full h-full flex flex-col rounded-2xl border shadow-2xl overflow-hidden
          ...
          >
            ...
            >
              <div
                className="w-[60px] sm:w-48 md:w-56 flex flex-col items-center sm:items-stretch border-r p-2 sm:p-4 transition-all duration-300 flex-shrink-0
              ...
              >
                <TabList className="flex flex-col gap-2 sm:gap-3 w-full mt-2 sm:mt-0">
                  {tabs.map((tab) => (
                    <Tab
                      ...
                      className={({ selected }) =>
                        clsx(
                          "w-full flex justify-center sm:justify-start items-center gap-0 sm:gap-3 p-3 sm:px-3 sm:py-2 rounded-xl transition-colors outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 border",
                          selected
                            ? "bg-slate-200 text-slate-800 dark:bg-white/5 dark:text-white border-white/10"
                            : "border-transparent text-slate-500 hover:bg-slate-200/50 dark:text-gray-400 dark:hover:bg-white/5",
                        )
                      }
                      title={tab.name}
                    >
                  ...
                  <Link
                    ...
                    onClick={() => setIsOpen(false)}
                    className="w-full flex justify-center sm:justify-start items-center gap-0 sm:gap-3 p-3 sm:px-3 sm:py-2 rounded-xl outline-none transition-colors text-slate-500 hover:bg-slate-200/50 dark:text-gray-400 dark:hover:bg-white/5"
                  >
                ...
                <div className="mt-auto space-y-4 w-full">
                  <button
                    ...
                    className="w-full flex items-center gap-0 sm:gap-2 p-3 sm:px-3 sm:py-2.5 rounded-xl outline-none transition-colors
