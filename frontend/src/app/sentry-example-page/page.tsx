...
//             target="_blank"
//             rel="noopener"
//             href="https://demo-me.sentry.io/issues/?project=4511026110136400"
//           >
//             Issues Page
//           </a>
...
export default function TraceTestButton() {
  const triggerFullStackTrace = async () => {
    try {
      // 🌟 This fetch matches the "localhost:8000" rule in your config
      // Sentry will automatically inject tracking headers into this request
      await fetch("http://localhost:8000/sentry-debug");
    } catch (error) {
